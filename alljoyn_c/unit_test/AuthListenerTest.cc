...
class DefaultAuthListenerWithPasswordTest : public DefaultAuthListenerNoPasswordTest {
  public:
    ...
    virtual void SetUp()
    {
        ...
        ASSERT_EQ(ER_OK, alljoyn_authlistener_setsharedsecret(m_defaultAuthListener, s_someValidPassword, ArraySize(s_someValidPassword)));
    }
};
...
{
    EXPECT_EQ(ER_OK, alljoyn_authlistener_setsharedsecret(m_defaultAuthListener, s_someValidPassword, ArraySize(s_someValidPassword)));
}

TEST_F(DefaultAuthListenerNoPasswordTest, shouldFailSetAuthListenerShorterThan4CharactersPassword)
{
    EXPECT_EQ(ER_BAD_ARG_2, alljoyn_authlistener_setsharedsecret(m_defaultAuthListener, s_someInvalidPassword, ArraySize(s_someInvalidPassword)));
}
