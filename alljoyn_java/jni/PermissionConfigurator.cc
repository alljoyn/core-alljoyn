...
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_create(JNIEnv* jenv, jobject thiz, jobject jbus)
{
    ...
    /*
     * Create a new C++ backing object for the Java PermissionConfigurator. This is
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_destroy
    (JNIEnv* jenv, jobject thiz, jobject jbus)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT jstring JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getManifestTemplateAsXml
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_setManifestTemplateFromXml
    (JNIEnv* jenv, jobject thiz, jstring jxml)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT jobject JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getApplicationState
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
    ...
    return jenv->GetStaticObjectField(CLS_PermissionConfiguratorApplicationState, jfid);
}
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_setApplicationState
    (JNIEnv* jenv, jobject thiz, jint jstate)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_signCertificate
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_reset
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT jobject JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getConnectedPeerPublicKey
    (JNIEnv* jenv, jobject thiz, jobject jguid)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_setClaimCapabilities
    (JNIEnv* jenv, jobject thiz, jshort jclaimCapabilities)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()I
 */
JNIEXPORT jshort JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getClaimCapabilities
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_setClaimCapabilityAdditionalInfo
    (JNIEnv* jenv, jobject thiz, jshort jclaimCapabilitiesAdditional)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()I
 */
JNIEXPORT jshort JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getClaimCapabilityAdditionalInfo
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_claim
    (JNIEnv* jenv, jobject thiz, jobject jcertAuth, jobject jadminGroupId, jobject jadminGroup, jobjectArray jcertArray, jlong jcertChainCount, jobjectArray jmanifestobjs, jlong jmaniCount)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_updateIdentity
    (JNIEnv* jenv, jobject thiz, jobjectArray jcertArray, jlong jcertCount, jobjectArray jmanifestobjs, jlong jmaniCount)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getIdentity
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT jobject JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getIdentityCertificateId
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_resetPolicy
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()[Lorg/alljoyn/bus/CertificateId;
 */
JNIEXPORT jobjectArray JNICALL Java_org_alljoyn_bus_PermissionConfigurator_getMembershipSummaries
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
    ...
    for (unsigned int i = 0; i < serial.size(); i++) {
        JLocalRef<jobject> jidcert = jenv->NewObject(CLS_CertificateId, mid);
        if (!jidcert) {
            return NULL;
        }
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_installMembership
    (JNIEnv* jenv, jobject thiz, jobjectArray jcertArray, jlong jcertCount)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_startManagement
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_endManagement
    (JNIEnv* jenv, jobject thiz)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
 ...
 */
JNIEXPORT void JNICALL Java_org_alljoyn_bus_PermissionConfigurator_installManifests
    (JNIEnv* jenv, jobject thiz, jobjectArray jmanifestobjs, jlong maniCount, jboolean jappend)
{
    QCC_DbgTrace(("%s", __FUNCTION__));
