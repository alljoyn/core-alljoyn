Pod::Spec.new do |s|
  ...
  s.ios.user_target_xcconfig = { 'OTHER_LDFLAGS' => '$(inherited) -lalljoyn -lajrouter -lAllJoynFramework_iOS -lstdc++',
  ...
  s.osx.user_target_xcconfig = { 'OTHER_LDFLAGS' => '$(inherited) -lalljoyn -lajrouter -lAllJoynFramework_macOS -lstdc++',
                             'OTHER_CFLAGS'  => '$(inherited) -DNS_BLOCK_ASSERTIONS=1 -DQCC_OS_GROUP_POSIX -DQCC_OS_DARWIN',
